...
<?php $__env->startSection('title', 'Welcome - Duck Vintage'); ?>
...
<div class="container">
    <div style="text-align: center; padding: 4rem 0;">
        ...
        <div style="margin-bottom: 3rem;">
            <a href="<?php echo e(route('products.index')); ?>" class="btn" style="font-size: 1.1rem; padding: 1rem 2rem; margin-right: 1rem;">Browse Products</a>
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-secondary" style="font-size: 1.1rem; padding: 1rem 2rem;">Create Account</a>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8_2\htdocs\DuckVintage\resources\views/welcome.blade.php ENDPATH**/ ?>