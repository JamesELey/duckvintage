...
<?php $__env->startSection('title', 'Privacy Policy - Duck Vintage'); ?>
...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h2>7. Cookies</h2>
            <p>We use cookies and similar tracking technologies. For more information, please see our <a href="<?php echo e(route('cookie-policy')); ?>">Cookie Policy</a>.</p>
            ...
            <ul>
                <li><strong>Exporting Your Data:</strong> Visit your <a href="<?php echo e(route('profile.show')); ?>">profile page</a> and click "Export My Data"</li>
                <li><strong>Deleting Your Account:</strong> Visit your <a href="<?php echo e(route('profile.show')); ?>">profile page</a> and request account deletion</li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8_2\htdocs\DuckVintage\resources\views/policies/privacy.blade.php ENDPATH**/ ?>