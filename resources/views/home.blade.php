...
<div class="hero-section" style="position: relative; height: 70vh; overflow: hidden; margin-bottom: 3rem;">
    <!-- Hero Image 1 -->
    <div class="hero-slide" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('{{ asset('fm_duck_02.png') }}'); background-size: cover; background-position: center; display: flex; align-items: center; justify-content: center; animation: fadeInOut 13.5s infinite;">
        <div class="container" style="text-align: center; z-index: 2; background-color: rgba(255, 255, 255, 0.1); padding: 2rem; border-radius: 12px; backdrop-filter: blur(10px);">
    ...
    <!-- Hero Image 2 -->
    <div class="hero-slide" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('{{ asset('fm_duck_05.png') }}'); background-size: cover; background-position: center; display: flex; align-items: center; justify-content: center; animation: fadeInOut 13.5s infinite 4.5s;">
        <div class="container" style="text-align: center; z-index: 2; background-color: rgba(255, 255, 255, 0.1); padding: 2rem; border-radius: 12px; backdrop-filter: blur(10px);">
    ...
    <!-- Hero Image 3 -->
    <div class="hero-slide" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('{{ asset('fm_duck_04.png') }}'); background-size: cover; background-position: center; display: flex; align-items: center; justify-content: center; animation: fadeInOut 13.5s infinite 9s;">
        <div class="container" style="text-align: center; z-index: 2; background-color: rgba(255, 255, 255, 0.1); padding: 2rem; border-radius: 12px; backdrop-filter: blur(10px);">
