...
@section('title', 'Terms of Service - Duck Vintage')
...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h2>10. Privacy</h2>
            <p>Your privacy is important to us. Please review our <a href="{{ route('privacy-policy') }}">Privacy Policy</a> to understand how we collect, use, and protect your information.</p>
            ...
            <div class="mt-4">
                <a href="{{ route('privacy-policy') }}" class="btn btn-secondary">Privacy Policy</a>
